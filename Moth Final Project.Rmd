...
```{r, echo=FALSE, warning = FALSE, fig.cap="Cullen and Frey graph depicting the appropriateness of theoretical distributions for model application given an input observation. Graph was interpreted according to the methodology of Cullen and Frey (1999) and Delignette-Muller (2014)"}
